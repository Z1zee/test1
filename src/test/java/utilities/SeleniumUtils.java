...
public class SeleniumUtils {
         ...
         * @param element - is clicked to open a new tab
         */
         ...
         * @param driver go to the webpage
        ...
        /**
         * This method will try to click on the element multiple times
         * by ignoring StaleElement exceptions
         * @param driver go to the webpage
         * @param locator to click on it
         * @param retries number of times to try
         * @throws InterruptedException
         */
        public static void clickWithTries(WebDriver driver, By locator, int retries) throws InterruptedException {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(15));
            wait.until(ExpectedConditions.alertIsPresent());
        ...
        public static void waitForSeconds(int numberOfSec){
            try{
                Thread.sleep(numberOfSec * 1000);
    ...
    /**
     * This method waits for text to apper in the element
